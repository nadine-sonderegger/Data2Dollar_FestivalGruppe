...
list_of_tweets = excel['Lower Text'].tolist()
...
for a, b in zip(list_of_links, list_of_tweets):
    ...
    newsbutton = WebDriverWait(driver, 20).until(EC.element_to_be_clickable((By.LINK_TEXT, 'News'))).click()
    ...
    result_stats_box = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, '//*[@id="result-stats"]')))
...
print(dataframe)
dataframe.to_excel("ResultsGoogleCrawl2.xlsx")
